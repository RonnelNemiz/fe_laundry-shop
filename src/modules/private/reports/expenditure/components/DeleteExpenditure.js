...
export default function DeleteExpenditure(props) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Delete Expenditures</DialogTitle>
        <DialogContent>
          <DialogContentText sx={{ fontWeight: "500" }}>
            Are you sure you want to delete the expenditures? "
            {selectedItem.title}"?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
