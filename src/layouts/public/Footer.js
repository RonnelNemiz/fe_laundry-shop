      ...
      <div className="container-footer conConFooterthis">
        <div className="row" id="footer-row">
          ...
          <div className="container1 col-md text-center">
            ...
            <div>
              <Link to="/" className="haco">
                Home
              </Link>
            </div>
            <div>
              <Link to="about" className="haco">
                About
              </Link>
            </div>
            <div>
              <Link to="/contact" className="haco">
                Contact
              </Link>
            </div>
            <div>
              <Link to="/order" className="haco">
                Order
              </Link>
            </div>
          </div>
          ...
          <div className="container1 col-md text-center">
            ...
            <div className="text-white mb-1" id="haco">
              <i className="fa-solid fa-envelope"></i>treslabanderas@gmail.com
            </div>
            <div className="text-white mb-1"></div>
          </div>
          <p className="copyRightStyle" id="haco">
            © 2023 Laundry Shop Management System. All Rights Reserved.
          </p>
        </div>
      </div>
    </section>
